...
model {
    // priors
    beta ~ normal(88, 5);
    sigma_w ~ cauchy(0, 5); // limited to lower 0
    sigma_s ~ cauchy(0, 10); // limited to lower 0


    sigma_e ~ cauchy(15, 5); // limited to lower 0
    sigma_sd_w ~ cauchy(0, 5); // limited to lower 0
    sigma_sd_sbj ~ cauchy(0, 5); // limited to lower 0
